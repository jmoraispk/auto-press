...
| `--toggle` | `PAGEDOWN` | Hotkey to start/stop |
...
3. **Press PageUp** — The position is saved
4. **Press PageDown** — Clicking starts (light turns green)
5. **Press PageDown again** to pause, close the window to quit
